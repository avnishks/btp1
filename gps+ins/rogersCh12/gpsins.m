function [sys,x0,str,ts] = gpsrcvr(t,x,u,flag,dt,p1i,p2i,p3i,p4i,p5i,p6i,p7i,p8i,p9i,p10i,p11i,p12i,vxni,vyni,vzni)
...
% compute relative range based on 4 selected satellites
      ...
      for j_sat=1:4
         ...
         d_rho_sat(j_sat,1) = u(j_sat+20) - (rho_user(j_sat) );
